...
MESSAGES: dict[Locale, dict[str, str]] = {
    Locale.TR: {
        ...
        "log_app_closed": "--- Uygulama Kapatıldı ---",
        "log_greet_clicked": "Selamla butonuna tıklandı.",
        "log_dialog_cancelled": "İsim girişi kullanıcı tarafından iptal edildi.",
        "log_name_entered": "Girilen isim: {name}",
        "log_empty_name": "Kullanıcı boş isim ile onayladı.",
        "log_popup_closed": "'{name}' için açılan popup kapatıldı.",
        "log_anon_popup_closed": "Anonim popup penceresi kapatıldı.",
    ...
    Locale.EN: {
        ...
        "log_greet_clicked": "Greet button clicked.",
        "log_dialog_cancelled": "Name input cancelled by user.",
        "log_name_entered": "Entered name: {name}",
        "log_empty_name": "User confirmed with empty name.",
        "log_popup_closed": "Popup for '{name}' closed.",
        "log_anon_popup_closed": "Anonymous popup window closed.",
